...
class DecisionEngine:
    ...
    Además de proyectos y tareas normales, puede decidir
    replanificar una tarea de escritorio fallida y luego permitir
    que el ciclo autónomo vuelva a seleccionarla para continuar.
    """
    ...
    def decidir_ampliado(
        ...
        if (
            ...
            return Decision(
                actuar=True,
                motivo=(
                    "El Director detectó una tarea "
                    "fallida que puede reconstruir "
                    "sus pasos futuros."
                ),
                prioridad=candidato.score,
                tipo=(
        ...
        if (
            ...
            return Decision(
                actuar=True,
                motivo=(
                    "El Director seleccionó una "
                    "tarea de escritorio ejecutable."
                ),
                prioridad=candidato.score,
                tipo=(
                    TipoDecisionAgente
